                                ...
                                <c:forEach items="${list}" var="o">
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="sub/${o.id}"><button class="btnSub">-</button></a> <strong>${o.amount}</strong>
                                            <a href="cart/${o.id}"><button class="btnAdd">+</button></a>
                                        </td>
                                        <td class="align-middle"><a href="remove/${o.id}" class="text-dark">
