...
public class FormThongKe extends JFrame {
    private JTabbedPane JPLthongKe;
    private JComboBox cbbThongKe;
    private JButton btnThongKe;
    private JButton btnXuat;
    private JTable tblSach;
    private JPanel JPL;
    private JComboBox ccbDocGia;
    private JButton btnThongKeDocGia;
    private JButton btnXuatDocGia;
    ...
    private JMenuItem ImnuQuanLiMuonTra;
    ...
    String pass;
    int user, vaitro, tab;
    DefaultTableModel dtbDocGia;
    String low1[] = {"mã độc giả", "tên độc giả", "giới tính", "năm sinh", "SĐT", "Địa chỉ"};
    DefaultTableModel dtbSach;
    String low[] = {"mã sách", "tên sách", "mã thể loại", "mã nhà xuất bản", "số lượng", "số trang"};
    ...
    public FormThongKe() {
        ...
        dtbSach = new DefaultTableModel(low, 0);
        tblSach.setModel(dtbSach);
        dtbDocGia = new DefaultTableModel(low1, 0);
        tblDocGia.setModel(dtbDocGia);
        //phím tắt ql vị trí
        ...
        ImnuDoiPass.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                formDoiPass pin = new formDoiPass();
                pin.setUser(user);
                pin.setPass(pass);
                pin.setVaitro(vaitro);
            }
    ...
    public class TieuDeNhay extends Thread {
        int icout = -1;
        String arrtext[] = {"Thống Kê Sách", "Thống", "Kê", "Sách"};
    ...
    public class TieuDeNhay1 extends Thread {
        int icout = -1;
        String arrtext[] = {"Thống Kê Độc Giả", "Thống", "Kê", "Độc", "Giả"};
    ...
    public class TieuDeNhay2 extends Thread {
        int icout = -1;
        String arrtext[] = {"Tổng Hợp", "Tổng", "Hợp"};
